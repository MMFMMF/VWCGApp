...
# Plan: SWOT Analysis Tool

## Objective

Implement the SWOT Analysis tool (AST-04) - a 4-quadrant matrix for Strengths, Weaknesses, Opportunities, and Threats with confidence levels (1-5) per item and visual matrix display.

## Tasks

### Task 1: Create SWOT Analysis Tool Component

**Action:** Create the SWOT Analysis component with 4-quadrant matrix
**Files:** src/components/tools/SWOTAnalysisTool.tsx
**Details:**
...
**Action:** Import the SWOT Analysis tool
...
- [ ] SWOT tool renders with 4 quadrant cards
- [ ] Each quadrant allows adding items with text input
- [ ] Confidence level selector (1-5) works for each item
- [ ] Items can be removed
- [ ] Summary shows total items and high-confidence count
- [ ] Data persists after refresh
- [ ] Tool appears in navigation at position 4
- [ ] Build completes successfully

## Must-Haves

- 4-quadrant matrix (Strengths, Weaknesses, Opportunities, Threats) (AST-04)
- Confidence levels (1-5) per item (AST-04)
