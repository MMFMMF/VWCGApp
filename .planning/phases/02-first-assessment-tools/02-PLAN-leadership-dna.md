...
# Plan: Leadership DNA Assessment Tool

## Objective

Implement the Leadership DNA Assessment tool (AST-02) - a 6-dimension assessment with current vs target values (0-10 scale) and dual-layer radar chart visualization showing both current state and aspirational targets.

## Tasks

### Task 1: Create Leadership DNA Tool Component

**Action:** Create the Leadership DNA assessment component with dual-layer radar chart
**Files:** src/components/tools/LeadershipDNATool.tsx
**Details:**
...
### Task 2: Update Badge Component for Size Prop

**Action:** Add size prop to Badge component for gap indicators
**Files:** src/components/shared/ui/Badge.tsx
**Details:**

Add optional `size` prop ('sm' | 'md' | 'lg') with responsive styling.

### Task 3: Update Tool Registry Index

**Action:** Import the Leadership DNA tool
...
- [ ] Each dimension has current AND target sliders (0-10 scale)
- [ ] Dual-layer radar chart shows both current (solid) and target (dashed)
- [ ] Gap calculations display correctly for each dimension
- [ ] Overall averages calculate correctly
- [ ] Gap assessment badge updates appropriately
- [ ] Data persists after refresh
- [ ] Tool appears in navigation at position 2
- [ ] Build completes successfully

## Must-Haves

- 6 dimensions: Vision, Execution, Empowerment, Decisiveness, Adaptability, Integrity (AST-02)
- Current vs Target values on 0-10 scale (AST-02)
- Dual-layer radar chart visualization (AST-02)
