...
# Plan: Business Emotional Intelligence Assessment Tool

## Objective

Implement the Business Emotional Intelligence Assessment tool (AST-03) - a 6-dimension assessment with multi-entry support for tracking changes over time. Features trend visualization to show EQ development trajectory.

## Tasks

### Task 1: Create Business EQ Tool Component

**Action:** Create the Business EQ assessment with multi-entry trend tracking
**Files:** src/components/tools/BusinessEQTool.tsx
**Details:**
...
### Task 2: Add Size Prop to Button Component

**Action:** Add size prop to Button for consistent sizing
...
**Action:** Import the Business EQ tool
...
- [ ] Business EQ tool renders with 6 dimension sliders
- [ ] Multi-entry system allows creating new assessment entries
- [ ] Date selector works for each entry
- [ ] Entry navigation switches between historical entries
- [ ] Delete entry works (when more than 1 entry exists)
- [ ] Radar chart shows current entry's scores
- [ ] Trend line chart appears when 2+ entries exist
- [ ] Overall EQ score calculates correctly
- [ ] Data persists after refresh
- [ ] Tool appears in navigation at position 3
- [ ] Build completes successfully

## Must-Haves

- 6 dimensions: Self Awareness, Self Regulation, Motivation, Empathy, Social Skills, Intuition (AST-03)
- Multi-entry support for tracking over time (AST-03)
- Trend tracking visualization with line chart (AST-03)
- Entry management (add, delete, navigate)
