...
What they provide: directional clarity. You learn which areas score strong and which areas score weak. You get a framework for thinking about your business that you may not have had before. For a CEO who has never formally assessed their operations, leadership capacity, or strategic readiness, a well-built free tool delivers 80% of the insight at zero cost.

What they miss: the interpretation layer. A free tool can tell you that your SOP maturity scores a 2 out of 5. It cannot tell you what that means in the context of your specific industry, growth stage, team composition, and strategic goals. It cannot tell you "I have seen this pattern in 40 other companies your size, and here is what happened next." That contextual interpretation requires a human who has seen the pattern before.
...
At this tier, the deliverable is not a score. It is a diagnosis. The consultant identifies the root causes, the interdependencies between problems, and the sequence in which they should be addressed. This is what I deliver through [World Consulting Group](https://kamyarshah.com/business-consulting/).

The value proposition at this tier is pattern recognition. A consultant who has conducted hundreds of engagements in the $2M to $25M range recognizes patterns that a first-time assessment cannot surface. They see that your [financial readiness](/blog/financial-readiness-can-your-business-afford-to-grow) gap is connected to your pricing model, which is connected to your sales process, which is connected to a leadership hire you have been deferring. That cross-functional view is what the investment buys.
...
Enterprise scope, enterprise price. Most companies in the $2M to $25M range do not need this tier. The situations that justify it: preparing for a major transaction (acquisition, merger, or private equity investment), entering a fundamental business model pivot, or recovering from a crisis that has affected multiple functions simultaneously.
...
I will be direct about this. The [VWCG Strategic Assessment](https://vwcg.app/invite) is free because it is the top of the funnel. Companies that use it and discover real gaps, the ones that score below a 3 on two or more dimensions, tend to come back for a paid engagement. The free tool demonstrates the value of the diagnostic framework. The paid engagement applies it with interpretation, context, and customized recommendations.

That is not a secret. It is the business model. And it works because the free tool is genuinely useful. It is built from the same diagnostic frameworks I use in paid engagements with [fractional COO](https://kamyarshah.com/fractional-coo/) clients. The questions, the scoring methodology, and the dimensional analysis are identical. What the paid engagement adds is the human layer: pattern recognition, cross-dimensional interpretation, and implementation guidance.
