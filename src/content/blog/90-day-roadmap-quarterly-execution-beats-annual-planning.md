...
pubDate: 2026-02-06
author: "Kamyar Shah"
tags: ["roadmap", "execution", "quarterly planning", "strategy"]
heroImage: "/blog/images/90-day-roadmap-quarterly-execution-beats-annual-planning.png"
draft: false
---
...
Annual plans from over 200 companies in the $3M to $20M range reveal a consistent pattern: by Q2, fewer than 30% of the original priorities remain the primary focus. The other 70% have been replaced, deferred, or quietly abandoned. The plan did not fail because the team lacked commitment. The plan failed because 12 months is too long a horizon for an organization operating at this speed.
...
**Kill criteria.** What triggers removing a priority mid-quarter. Without kill criteria, the roadmap only grows. New items get added as emergencies arise, but nothing gets removed. By week 8, the team is drowning. The backlog exceeds capacity by 200%. Kill criteria define the conditions for pausing or eliminating priorities. This includes resource unavailability, failed dependencies, external changes, or ROI no longer justifying the effort.

**Weekly check-in cadence.** Fifteen minutes. Status, blockers, help needed. Not a presentation. Not a status meeting with slides. A pulse check to verify each priority still has an active owner. The cadence creates accountability. Without it, the roadmap is a document. With it, the roadmap becomes a management system.


## The Capacity Problem Nobody Talks About

This is the most common cause of roadmap failure, and it has nothing to do with strategy or execution quality.

Most roadmaps are overloaded from day one. The leadership team sits in a planning session and lists everything they want to accomplish. All of it goes on the roadmap because "these are all important." The math is never run. Nobody asks how many items can actually be completed in 90 days given available team hours, competing demands, and realistic execution rates.

A $12M company placed 24 items on their Q3 roadmap. They completed 7. The next quarter, they placed 22 items on the list and completed 6. The problem was not the team. The problem was the planning. Roadmaps were built dead on arrival.

The fix is simple math. Total available team hours per quarter minus operational maintenance (usually 50% to 65% of capacity) minus unplanned demands (10% to 15%) equals actual project hours. Divide by estimated hours per priority to find maximum item count. This number will be smaller than preferred. That is the point.
...
Before the quarter begins, define what done looks like for each item. "Improve onboarding" is not completion criteria. "Reduce average onboarding time from 58 days to 35 days, measured by HR system data" is. "Launch new website" is vague. "Website live, indexed by search engines, and processing orders by March 15" is verifiable.

This discipline forces honest scoping. When outcomes must be defined, priorities that are too vague or too large become visible immediately. "Improve customer experience" cannot be completed in 90 days because it is not a project. It is a theme. Break it into a specific, measurable initiative or remove it.
...
The quarterly reset is an audit, not a fresh start. Three questions structure it. What was completed, and what was learned from the execution? What failed to be completed, and why? What has changed in the business that should alter priorities?

Answering these questions thoroughly takes two to three hours. That investment produces a roadmap for the next 90 days that is informed by the last 90 days. This is the improvement loop that annual plans cannot provide. Each quarter builds on the lessons of the previous quarter. Execution capability compounds over time.
...
The [VWCG Strategic Assessment](https://vwcg.app/invite) includes a 90-Day Roadmap module that evaluates your execution framework. It assesses how priorities are selected, how ownership is assigned, whether capacity math exists, and whether your completion rate reflects realistic planning or chronic overload.
